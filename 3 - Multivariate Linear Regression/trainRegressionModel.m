...
% Auto-generated by MATLAB on 02-Feb-2024 16:34:21
...
predictorNames = {'Acceleration', 'Cylinders', 'Displacement', 'Horsepower', 'Weight'};
...
concatenatedPredictorsAndResponse.MPG = response;
linearModel = fitlm(...
...
trainedModel.RequiredVariables = {'Acceleration', 'Cylinders', 'Displacement', 'Horsepower', 'Weight'};
...
for fold = 1:KFolds
    ...
    concatenatedPredictorsAndResponse.MPG = trainingResponse;
    linearModel = fitlm(...
        concatenatedPredictorsAndResponse, ...
        'linear', ...
        'RobustOpts', 'off');
